            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch">
                    <div class="icon-box icon-box-clr-1">
                        ...
                        <h4 class="title"><a href="#about"><?php echo $value->title;?></a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="coursecard-single">
                        <div class="grids5-info position-relative">
                            <img src="assets/images/<?php echo $value->image; ?>.jpg" alt="" class="img-fluid" />
                            <div class="meta-list">
                        ...
                        <div class="content-main-top">
                            <div class="content-top mb-4 mt-3">
                                <ul class="list-unstyled d-flex align-items-center justify-content-between">
                                    <li> <i class="fas fa-book-open"></i> <?php echo $value->lesson_count; ?> Lesson</li>
                                    <li> <i class="fas fa-star"></i> <?php echo $value->rating; ?></li>
                                </ul>
                            </div>
                            <h4><a href="courses"><?php echo $value->title; ?></a></h4>
                            <p><?php echo $value->description; ?>.</p>
